// gcc -o gauge_fix_coulomb gauge_fix_coulomb.c source/lattice.c source/SU2_ops.c source/SU3_ops.c source/math_ops.c source/gauge_fixing.c source/fourvector_field.c  -lm -fopenmp -O4 -march=skylake
// icc -o gauge_fix_coulomb gauge_fix_coulomb.c source/lattice.c source/SU2_ops.c source/SU3_ops.c source/math_ops.c source/gauge_fixing.c source/fourvector_field.c  -lm -fast -xCASCADELAKE -g -qopenmp
